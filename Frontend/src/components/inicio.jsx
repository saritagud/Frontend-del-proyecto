    ...
    return(
        ...
        <section className=" p-5">
            ...
            <div className="flex flex-col items-center w-full mb-5">
                ...
                <div className="flex justify-center font-Urbanist grid-cols-2 text-lg  my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor">
                    <FaCheckCircle className="text-5xl lg:mr-10 mr-5"/>
                ...
                <div className="flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor">
                    <FaChalkboardTeacher className="text-5xl lg:mr-10 mr-5"/>
                ...
                <div className="flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor">
                    <FaBook className="text-5xl lg:mr-10 mr-5"/>
                ...
                <div className="flex justify-center font-Urbanist grid-cols-2 text-lg my-4 font-bold items-center rounded-2xl p-3 w-[100%] shadow-2xl bg-secundaryColor">
                    <FaClock className="text-5xl lg:mr-10 mr-5"/>
