        ...
        <div>
            ...
            <section className="flex flex-col items-center">
                ...
                <form className="flex flex-col items-center bg-verdeClaro h-full w-72 lg:w-80 rounded-2xl border-2 border-solid border-grisClaro p-4 mb-14 shadow-2xl" onSubmit={handleSubmit}>
                    ...
                    <button className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 bg-verdeOscuroFuerte border-2  rounded-2xl font-Urbanist m-5 text-white text-xl p-3 w-56 font-bold ">Registrar</button>
                </form>
            </section>
        </div>
    );
