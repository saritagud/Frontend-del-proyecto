...
function Login() {
    ...
    const estiloInput =
        'border-2 border-verdeOscuroFuerte h-14 text-left w-full rounded-2xl p-3 font-Urbanist text-xl font-bold';
    ...
    return (
        <div>
            ...
            <section className="flex flex-col  items-center">
                ...
                <form
                    className="flex flex-col items-center bg-verdeClaro h-auto w-72 lg:w-80 rounded-2xl border-2 border-solid border-grisClaro p-4 mb-16 shadow-2xl"
                ...
                >
                    ...
                    <input
                        ...
                        name="contrasena"
                    ></input>
                    <button className="bg-verdeOscuroFuerte border-2  rounded-2xl font-Urbanist mt-7 text-white text-xl p-3 w-52 font-bold ">
                        Iniciar Sesión
                    </button>

                    <div className="flex justify-between items-center mt-5">
                        <div className="h-1 w-32 bg-verdeOscuroFuerte "></div>{' '}
                        <p className="m-2 text-xl text-verdeOscuroFuerte">o</p>{' '}
                        <div className="h-1 w-32 bg-verdeOscuroFuerte"></div>
                    </div>
