...
function Login() {
    ...
    const estiloInput = "border-2 border-compPrimaryColor h-14 text-left w-full rounded-2xl p-3 font-Urbanist text-xl font-bold";
    ...
    return (
        <div className="bg-bgColor">
            ...
            <section className="flex flex-col items-center">
                ...
                <form className="flex flex-col items-center bg-contrastSecundaryColor h-auto w-72 lg:w-80 rounded-2xl border-2 border-solid border-neutralColor p-4 mb-16 shadow-2xl" onSubmit={handleSubmit}>
                    ...
                    <button className="bg-compPrimaryColor border-2  rounded-2xl font-Urbanist mt-7 text-white text-xl p-3 w-52 font-bold ">Iniciar Sesión</button>

                    <div className="flex justify-between items-center mt-5">
                        <div className="h-1 w-32 bg-compPrimaryColor "></div> <p className="m-2 text-xl text-compPrimaryColor">o</p> <div className="h-1 w-32 bg-compPrimaryColor"></div>
                    </div>
